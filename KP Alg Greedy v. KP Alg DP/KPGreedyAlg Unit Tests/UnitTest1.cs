...
namespace KPGreedyAlg_Unit_Tests
{
    ...
    public class GreedyTests
    {
        ...
        public void TestMethodGreedy()
        {
            ...
            var t2 = KPGreedyAlg.Solve(new int[2] { 2, 3 }, new int[2] { 3, 4 }, 0, 2);
            var t3 = KPGreedyAlg.Solve(new int[0], new int[0], 3, 0);
            var t4 = KPGreedyAlg.Solve(new int[1] { 3 }, new int[1] { 2 }, 3, 1);
            var t5 = KPGreedyAlg.Solve(new int[1] { 3 }, new int[1] { 2 }, 1, 1);
            ...
            CollectionAssert.AreEqual(new int[5] { 1, 1, 0, 1, 0 }, t11.Item1);
            ...
            CollectionAssert.AreEqual(new int[10] { 1, 1, 1, 1, 1, 1, 0, 0, 1, 0 }, t16.Item1);

            Assert.AreEqual(107, t17.Item2); //Not Optimal, Off by 1
            CollectionAssert.AreEqual(new int[10] { 1, 1, 1, 1, 0, 1, 1, 1, 1, 0 }, t17.Item1);
        }
    }
}